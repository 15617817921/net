...
import com.zhouyou.http.demo.mytest.Constant;
import com.zhouyou.http.demo.mytest.DialogUtils;
import com.zhouyou.http.demo.mytest.SaveUtils;
import com.zhouyou.http.demo.utils.FileUtils;
import com.zhouyou.http.demo.utils.LogUtils;
...
import static com.zhouyou.http.demo.mytest.Constant.Save.TOKEN_ID;
import static com.zhouyou.http.demo.mytest.Constant.Save.USERID;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onPut(View view) {
        String authorization = (String) SaveUtils.get(this, TOKEN_ID, "");
        String userid = (String) SaveUtils.get(this, USERID, "");
        PutRequest requestBody = new PutRequest("/user/" + userid + "/password/");
//        requestBody.params()
//        EasyHttp.put("/user/" + userid + "/password/")
//                .headers("Authorization", authorization)
//                .requestBody()
        requestBody.headers("Authorization", authorization)
                .params("old_password", "123456")
                .params("new_password", "111111")
                .params("confirm_password", "111111")
                .uploadType(BaseBodyRequest.UploadType.BODY)//是拼接还是放入body 针对文件
                .execute(new SimpleCallBack<String>() {
                    @Override
                    public void onError(ApiException e) {
                        showToast(e.getMessage());
...
//                });
    ...
    public void onDelete(View view) {
        ...
        String authorization = (String) SaveUtils.get(this, Constant.Save.TOKEN_ID, "");
        String userid = (String) SaveUtils.get(this, Constant.Save.USERID, "");
        LogUtils.E(authorization + "\n" + userid);
        CustomRequest request = EasyHttp.custom()
                .addConverterFactory(GsonConverterFactory.create(new Gson()))
                .build();
        LoginService mLoginService = request.create(LoginService.class);
        request.call(mLoginService.loginOut(authorization, userid, authorization))
//                .subscribe(new ProgressSubscriber<ResponseBody>(DialogUtils.loading(this),false,true) {
                .subscribe(new ProgressSubscriber<ResponseBody>(DialogUtils.loading(this),false,true) {
...
//        EasyHttp.delete("/user/login/" + userid + "/")
//                .headers("Authorization", authorization)
//                .params(httpParams)
