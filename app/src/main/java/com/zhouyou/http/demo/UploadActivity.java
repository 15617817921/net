...
public class UploadActivity extends AppCompatActivity {
    ...
    public void onUploadImage(View view) {///relation/file/batch_upload/
        String authorization = (String) SaveUtils.get(this, Constant.Save.TOKEN_ID, "");
        File file = new File("/storage/emulated/0/Pictures/1595320021845.jpeg");
        UIProgressResponseCallBack mUIProgressResponseCallBack = new UIProgressResponseCallBack() {
            @Override
            public void onUIResponseProgress(long bytesRead, long contentLength, boolean done) {
                int progress = (int) (bytesRead * 100 / contentLength);
        ...
        EasyHttp.post("/relation/file/batch_upload/")
                .headers("Authorization", authorization)
                .params("file_type", "picture")
                .params("classify", "user")
//                .baseUrl("http://106.15.42.39")
    ...
    public void onUploadMoreImage(View view) {///relation/file/batch_upload/
        String authorization = (String) SaveUtils.get(this, Constant.Save.TOKEN_ID, "");
        File file = new File("/storage/emulated/0/Pictures/1595320021845.jpeg");
        ...
        EasyHttp.post("/relation/file/batch_upload/")
                ...
                .params("classify", "user")
//                .baseUrl("http://106.15.42.39")
                .addFileParams("file", list_file, mUIProgressResponseCallBack)
                .execute(new ProgressDialogCallBack<String>(mProgressDialog, true, true) {
                    @Override
                    public void onSuccess(String s) {
                        showToast(s);
